...
- (void)touchesBegan:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event {
    ...
    NSLog(@"AView touchesBegan : %@", NSStringFromCGPoint(touchPoint));
...
- (void)touchesMoved:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event {
    UITouch *touch = (UITouch *)[touches anyObject];
    CGPoint touchPoint = [touch locationInView:self.superview];
    NSLog(@"AView touchesMoved : %@", NSStringFromCGPoint(touchPoint));
    self.center = touchPoint;
}
...
- (void)touchesEnded:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event {
    UITouch *touch = (UITouch *)[touches anyObject];
    CGPoint touchPoint = [touch locationInView:self.superview];
    NSLog(@"AView touchesEnded : %@", NSStringFromCGPoint(touchPoint));
    self.center = touchPoint;
}
...
- (void)touchesCancelled:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event {
    UITouch *touch = (UITouch *)[touches anyObject];
    CGPoint touchPoint = [touch locationInView:self.superview];
    NSLog(@"AView touchesCancelled : %@", NSStringFromCGPoint(touchPoint));
    self.center = touchPoint;
}
