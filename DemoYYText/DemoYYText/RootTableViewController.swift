...
class RootTableViewController: UITableViewController {
    ...
    */
    ...
    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        self.example = (self.examples[indexPath.row] as? String)!
        self.performSegueWithIdentifier("SegueExample", sender: self)
    }
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        if segue.identifier == "SegueExample" {
            let vc = segue.destinationViewController as! ExampleViewController
            vc.title = self.example
        }
    }
